...
export type ChallengeResolvers<ContextType = any, ParentType = ResolversTypes['Challenge']> = {
...
export type MutationResolvers<ContextType = any, ParentType = ResolversTypes['Mutation']> = {
  updateChallenge?: Resolver<ResolversTypes['Challenge'], ParentType, ContextType, MutationUpdateChallengeArgs>,
  deleteChallenge?: Resolver<ResolversTypes['Challenge'], ParentType, ContextType, MutationDeleteChallengeArgs>,
};
...
export type QueryResolvers<ContextType = any, ParentType = ResolversTypes['Query']> = {
  ...
  challenge?: Resolver<Maybe<ResolversTypes['Challenge']>, ParentType, ContextType, QueryChallengeArgs>,
};
