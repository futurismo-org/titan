...
class Client {
  ...
  getAccessToken = async (
    ...
    this.TokenRequestHeaderParams.oauth_verifier = verifier; // eslint-disable-line
    ...
    return {
      oauth_token: result.oauth_token, // eslint-disable-line
      oauth_token_secret: result.oauth_token_secret // eslint-disable-line
    };
  };
