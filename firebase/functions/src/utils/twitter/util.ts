 ...
 */
export const createHeaderString = (params: any): string =>
 ...
 */
export const encodeParamsToString = (params: any): string =>
  Object.keys(params)
    .sort()
    .map(key => `${encodeURIComponent(key)}=${encodeURIComponent(params[key])}`)
    .join('&');
 ...
 */
export const parseFormEncoding = (formEncoded: string): any =>
...
export const createTokenRequestHeaderParams = (
  ...
  Object.assign(
    {},
    callback ? { oauth_callback: callback } : {}, // eslint-disable-line
    {
      oauth_consumer_key: consumerKey, // eslint-disable-line
      oauth_nonce: randomStrings(), // eslint-disable-line
      oauth_signature_method: 'HMAC-SHA1', // eslint-disable-line
      oauth_timestamp: new Date().getTime() / 1000 // eslint-disable-line
    },
    token ? { oauth_token: token } : {}, // eslint-disable-line
    { oauth_version: '1.0' }, // eslint-disable-line
    params
  );
...
export const createSignature = (
  ...
  return Object.assign({}, params, { oauth_signature: signature }); // eslint-disable-line
};
